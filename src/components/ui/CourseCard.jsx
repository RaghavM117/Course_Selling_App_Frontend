...
export default function CourseCard({
    ...
    return (
        ...
        >
            {/*course image*/}
            {course.image && (
                <div className="h-36 -mx-5 -mt-5 mb-3 rounded-t-xl overflow-hidden">
                    <img
                        src={course.image}
                        alt={course.title}
            ...
            {badge && (
                <span
                    className={`self-start text-[11px] font-semibold px-2.5 py-0.5 rounded-full tracking-wide ${badgeClass}`}
                >
                    {badge}
                </span>
            )}
