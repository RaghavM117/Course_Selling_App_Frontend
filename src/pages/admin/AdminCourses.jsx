...
export default function AdminCourses() {
  ...
  const { data, loading, error, refetch } = useAsync(() => getAdminCourses(), [])
    ...
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      {!loading && !error && courses.length === 0 && (
        <EmptyState
          ...
          action={{ label: '+ Create Course', onClick: () => navigate('/admin/courses/create') }}
        />
      )}
              ...
              actions={[
                {
                  label: 'Edit',
                  variant: 'outline',
                  onClick: () => navigate(`/admin/courses/edit/${course._id}`, { state: { course } }),
                },
                {
                  label: deleting === course._id ? '…' : 'Delete',
                  variant: 'danger',
